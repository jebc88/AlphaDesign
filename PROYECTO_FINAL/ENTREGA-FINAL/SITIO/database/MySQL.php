...
class database {
    ...
    //Devuelve todas las maquinas virtuales activas
    static function getActiveVM(){
        $vms = array();
        $handler = self::openConnection();
        $sql = 'CALL obtenerVMActivas()';
        $array = $handler->query($sql);
    ...
    //Devuelve todas las maquinas virtuales inactivas
    static function getInactiveVM(){
        $vms = array();
        $handler = self::openConnection();
        $sql = 'CALL obtenerVMInactivas()';
        $array = $handler->query($sql);
    ...
    //Devuelve todas las maquinas virtuales
    static function getAllVMs(){
        $vms = array();
        $handler = self::openConnection();
    ...
    //Desactiva un registro de maquina virtual, recibe como parametro idMaquinaVirtual.
    static function activateVM($idvm){
        $msg = array();
        $bindArray[]=$idvm;
        $handler = database::openConnection();
        $sql = 'CALL activarVM(?)';
    ...
    //Activa un registro de maquina virtual, recibe como parametro idMaquinaVirtual.
    static function deactivateVM($idvm, $id){
        $msg = array();
        $bindArray[]=$idvm;
        $bindArray[]=$id;
        $handler = database::openConnection();
        $sql = 'CALL desactivarVM(?,?)';
        $result = $handler->prepare($sql);
        $result->execute($bindArray);
